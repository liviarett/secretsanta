...
$email,
"Your Secret Santa!",
'<!doctype html><html class="no-js" lang="" style="padding: 0 !important; margin: 0; text-align: center; font-family: Helvetica;  color: #7a1414"><head><meta charset="UTF-8"><meta http-equiv="x-ua-compatible" content="ie=edge"><title>Secret Santa</title><meta name="viewport" content="width=device-width, initial-scale=1"><style>;@media (max-width: 600px) {h1 {font-size: 50px;padding: 2px !important;margin-bottom: 100px;} html{background-size: 200%;} body{padding: 3px !important;}}</style></head><body style="min-height: 400px; padding: 4px; margin: 0; background: url(http://liviarett.com/secretsanta/images/winterbackground.jpg); background-color: #243553; background-size: 100%; background-repeat: no-repeat;"><h1 style="margin: 0; font-size: 80px; font-weight: 400; padding: 10px; margin: 70px; font-family: Helvetica, sans-serif; color: #7a1414;">Your Secret Santa match is...</h1><p style="font-size: 30px; text-align: center; color: rgb(255, 255, 255); display: block; width: 100%; padding: 20px 0; margin: 0; background-color: #7a1414;">' + toProperCase($match) + '!</p></body></html>',
{token: "75c9d417-7cf1-4376-be10-2b1348b0a066"});
	...
	function sendAllSantas($email) {
		var santaMatches = '';
		for (santaIndex = 0; santaIndex < secretSantas.length; santaIndex++) {
			santaMatches += '<p>' + toProperCase(secretSantas[santaIndex].name) + ' got ' + toProperCase(secretSantas[santaIndex].match) + '</p>';
			console.log(santaMatches);
		};
		Email.send("ss.secretsanta.app@gmail.com",
$email,
"The full list of Santas!",
'<!doctype html><html class="no-js" lang="" style="padding: 0 !important; margin: 0; text-align: center; font-family: Helvetica; color: #7a1414"><head><meta charset="UTF-8"><meta http-equiv="x-ua-compatible" content="ie=edge"><title>Secret Santa</title><meta name="viewport" content="width=device-width, initial-scale=1"><style>@media (max-width: 600px) {h1 {font-size: 50px;padding: 2px !important;margin-bottom: 100px;} html{background-size: 200%;} body{padding: 3px !important;}} p {font-size: 30px; text-align: center; color: rgb(255, 255, 255); display: block; width: 100%; padding: 20px 0; margin: 0; background-color: #7a1414;}</style></head><body style="min-height: 400px; padding: 20px; margin: 0; background: url(http://liviarett.com/secretsanta/images/winterbackground.jpg); background-color: #243553; background-size: 100%; background-repeat: no-repeat;"><h1 style="margin: 0; font-size: 80px; font-weight: 400; padding: 70px; margin: 70px; font-family: Helvetica, sans-serif; color: #7a1414;">The Santas are...</h1>' + santaMatches.toString() + '</body></html>',
{token: "75c9d417-7cf1-4376-be10-2b1348b0a066"});
	};
});