...
'<!doctype html><html class="no-js" lang=""><head><meta charset="UTF-8"><meta http-equiv="x-ua-compatible" content="ie=edge"><title>Secret Santa</title><meta name="viewport" content="width=device-width, initial-scale=1"><style>*{background-size: cover;}html{padding: 0; margin: 0; background-color: rgb(36, 53, 83); text-align: center; font-family: Helvetica;}body{min-height: 400px; margin: 0;}h1{margin: 0; font-size: 80px; font-weight: 400; padding: 70px; margin: 70px; font-family: "Helvetica", sans-serif; color: #7a1414;}p{font-size: 30px; text-align: center; color: rgb(255, 255, 255); display: block; width: 100%; padding: 20px 0; margin: 0; background-color: #7a1414;}@media (max-width: 600px){html{background-size: 200%;}h1{font-size: 50px;line-height: 1.5;padding: 2px;margin: 10px;margin-bottom: 100px;}}</style></head><body><div style="background-color:#243553;"><!--[if gte mso 9]> <v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t"> <v:fill type="tile" src="http://liviarett.com/secretsanta/images/winterbackground.jpg" color="#243553"/> </v:background><![endif]--> <table height="100%" width="100%" cellpadding="0" cellspacing="0" border="0"> <tr> <td valign="top" align="left" background="http://liviarett.com/secretsanta/images/winterbackground.jpg" background-size="10%"><h1>Your Secret Santa match is...</h1><p>' + toProperCase($match) + '!</p></td></tr></table></div></body></html>',
{token: "75c9d417-7cf1-4376-be10-2b1348b0a066"});
	...
	function sendAllSantas($email) {
		var santaMatches = '';
		for (santaIndex = 0; santaIndex < secretSantas.length; santaIndex++) {
			santaMatches += '<p style="font-size: 30px; color: rgb(220, 220, 220); display: block; width: 100%; background-color: #7a1414;">' + toProperCase(secretSantas[santaIndex].name) + ' got ' + toProperCase(secretSantas[santaIndex].match) + '</p>';
		};
		Email.send("ss.secretsanta.app@gmail.com",
$email,
"The full list of Santas!",
'<!doctype html><html class="no-js" lang=""><head><meta charset="UTF-8"><meta http-equiv="x-ua-compatible" content="ie=edge"><title>Secret Santa</title><meta name="viewport" content="width=device-width, initial-scale=1"><style>*{background-size: cover;}html{padding: 0; margin: 0; background-color: rgb(36, 53, 83); text-align: center; font-family: Helvetica;}body{min-height: 400px; margin: 0;}h1{margin: 0; font-size: 80px; font-weight: 400; padding: 70px; margin: 70px; font-family: "Helvetica", sans-serif; color: #7a1414;}p{font-size: 30px; text-align: center; color: rgb(255, 255, 255); display: block; width: 100%; padding: 20px 0; margin: 0; background-color: #7a1414;}@media (max-width: 600px){html{background-size: 200%;}h1{font-size: 50px;line-height: 1.5;padding: 2px;margin: 10px;margin-bottom: 100px;}}</style></head><body><div style="background-color:#243553;"><!--[if gte mso 9]> <v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t"> <v:fill type="tile" src="http://liviarett.com/secretsanta/images/winterbackground.jpg" color="#243553"/> </v:background><![endif]--> <table height="100%" width="100%" cellpadding="0" cellspacing="0" border="0"> <tr> <td valign="top" align="left" background="http://liviarett.com/secretsanta/images/winterbackground.jpg" background-size="10%"><h1>The Santas are...</h1>' + santaMatches.toString() + '</td></tr></table></div></body></html>',
{token: "75c9d417-7cf1-4376-be10-2b1348b0a066"});
	};
});